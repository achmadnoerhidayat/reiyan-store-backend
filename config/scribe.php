...
return [
    ...
    'title' => config('app.name') . ' Game Topup API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Dokumentasi resmi untuk integrasi layanan Topup Game Reiyan Store.',
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                'api/*',        // Buang semua route dari api.php
                'sanctum/*',    // Buang route bawaan sanctum
                'up',           // Buang health check
                'storage/*',    // Buang route storage
                '_debugbar/*',  // Jika pakai debugbar
            ],
        ],
    ],
